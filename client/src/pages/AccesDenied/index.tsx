      ...
      <section className="bg-white dark:bg-gray-900 ">
          <div className="container flex items-center min-h-screen px-6 py-12 mx-auto">
              <div>
                  ...
                  <h1 className="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">You are not Authorized to use this page </h1>
                  <p className="mt-4 text-gray-500 dark:text-gray-400">Sorry,
                  you are not authorized to open this page . Thank you..! </p>
